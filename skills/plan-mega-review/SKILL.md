...
description: Garry Tan's Mega Plan Review Mode. Use when the user wants a maximum-rigor review of an implementation plan, design doc, or architectural proposal — especially when they say "mega plan review", "review my plan", "scope expansion", "hold scope", "scope reduction", "build the cathedral", or ask for a thorough/adversarial/boil-the-ocean plan critique. Three modes (EXPANSION / HOLD SCOPE / REDUCTION) with mandatory system audit, error/rescue map, failure-mode registry, security threat model, observability and deploy review. Review only — do NOT implement.
---
...
*Source: Garry Tan's Mega Plan Review Mode v2.0.0*
*Original gist: https://gist.github.com/garrytan/120bdbbd17e1b3abd5332391d77963e7*
