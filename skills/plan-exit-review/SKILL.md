...
description: Garry Tan's plan-exit-review. Use when the user wants an interactive pre-implementation plan review — keywords like "plan exit review", "review my plan", "exit plan mode review", "scope challenge", "big change vs small change review", or a request for opinionated, section-by-section critique of an implementation plan before coding. Walks Step 0 (scope challenge) then Architecture → Code Quality → Tests → Performance with stop-points for AskUserQuestion. Review only — do NOT implement.
---
...
*Source: Garry Tan's plan-exit-review skill v2.0.0*
*Original gist: https://gist.github.com/garrytan/001f9074cab1a8f545ebecbc73a813df*
